      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="col-span-full lg:col-span-1">
          ...
          <CardContent className="flex flex-wrap gap-4 flex-col">
            <Button>
              <Link href="/portal/prefeitura/requisicoes">Ver Requisições</Link>
            </Button>
            <Button variant="outline">
              <Link href="/portal/prefeitura/perfil">Acessar Perfil</Link>
            </Button>
            <Button variant="outline">
              <Link href="/portal/prefeitura/suporte">Suporte</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
